...
exports.analyzeStroke = exports.analyzeParkinson = void 0;
...
async function analyzeParkinson(videoPath) {
...
exports.analyzeParkinson = analyzeParkinson;
async function analyzeStroke(audioPath) {
    const model = genAI.getGenerativeModel({ model: "gemini-1.5-pro" });
    const prompt = `
...
exports.analyzeStroke = analyzeStroke;
